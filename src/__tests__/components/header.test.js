...
describe('Header', () => {
  it('should render <Hedaer /> with a background', () => {
  ...
  it('should render <Hedaer /> without a background', () => {
    const { container, getByText, queryByTestId } = render(
      <Header bg={false}>
        <Header.Frame>
          <Header.Logo src="/logo.svg" alt="Netflix" />
          <Header.Button>Signn</Header.Button>
  ...
  it('should render the full <Header /> with a background', () => {
    const { container, getByText, getByTestId } = render(
      <Header src="joker1">
        <Header.Frame>
          <Header.Group>
          ...
          <Header.Group>
            ...
            <Header.Profile>
              <Header.Picture src="/images/user.png" />
              <Header.Dropdown>
                <Header.Group>
                  <Header.Picture src="/images/user.png" />
                  <Header.TextLink>John</Header.TextLink>
                </Header.Group>
                <Header.Group>
    ...
    expect(getByTestId('search-input').value).toEqual('Joker');
